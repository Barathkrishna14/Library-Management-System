...
const HistoryBook = () => {
  ...
  const getIssuedBooks = async()=>{
    try{
      const res = await fetch('http://localhost:8080/Library/BookHistory',{ crossDomain: true })         
        ...
        <div>
            ...
            <Container className="mt-4">
             ...
             <ListGroup.Item as={Link} to="/user-section"  variant="info">Users</ListGroup.Item>
              ...
              <ListGroup.Item as = {Link} to="/history" variant="info" active>Book History</ListGroup.Item>
            </ListGroup>
                    </Col>
                    <Col md={10}>
