...
const AddUser = (e) => {
    ...
    async function handleSubmit(event){
        ...
        await fetch("http://localhost:8080/Library/user?name=" +name+ "&email=" + email + "&phone=" + phone +"&password="+ password + "&cpassword=" +cpassword,{crossDomain:true})
                    ...
                    <form className="signup-form" onSubmit={handleSubmit}>
                        ...
                        <div className="container-signup-form-btn">
                            <div className="wrap-signup-form-btn"> 
                                <button className="signup-form-btn" >Add User</button>
                            </div>
                        </div>
                    </form>
                </div>
